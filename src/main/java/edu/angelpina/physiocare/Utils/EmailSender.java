...
public class EmailSender {
    ...
    public static void sendMail(String to,
        ...
        String user = "me";
        //MimeMessage emailContent = createEmail("apg17499@gmail.com", "apg17499@gmail.com", "Otyrop Subject", "Hello222 World!");
        MimeMessage emailContent=
                createEmailWithAttachment(to, from, subject, bodyText, fileDir);
        // Send the email
